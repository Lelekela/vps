...
TOKEN = '7771921674:AAFBVmV2AzVvB7dr5JUSFYdOzwZd5wQEglw'
MONGO_URI = 'mongodb+srv://Kamisama:Kamisama@kamisama.m6kon.mongodb.net/'
FORWARD_CHANNEL_ID = -1002192997432
CHANNEL_ID = -1002192997432
error_channel_id = -1002192997432
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"
                                       ...
                                       "*Please contact the owner for assistance: @VIPKAMISAMA.*", 
                                       reply_markup=create_inline_keyboard(), parse_mode='Markdown')
            return
